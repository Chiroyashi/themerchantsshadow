    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 p-6 flex flex-col items-center justify-center font-sans">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-3xl sm:text-5xl font-black tracking-tighter uppercase italic leading-none">Setup Room</h1>
        ...
        <div className="relative">
          ...
          <div className={`p-6 rounded-3xl shadow-2xl relative overflow-hidden transition-all duration-700 z-20
            ...
            <div className="flex items-center justify-between mb-5">
              <div className="flex items-center gap-3">
                ...
                <div className="pl-2">
                  <h3 className={`font-black text-xl sm:text-2xl transition-colors duration-300 ${nameLength >= 3 ? 'text-emerald-300' : 'text-white'}`}>NAMA PEMAIN</h3>
                </div>
              </div>
          ...
          {/* Action Cards */}
          <div className={`space-y-3 mt-3 ml-2 mr-6 transition-all duration-700 ease-out
            ${nameLength >= 3 ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-8 pointer-events-none'}`}>

            <button
              onClick={() => handleCreateRoom(tempName)}
            ...
            >
              ...
              <div className="relative z-10">
                <h3 className="font-black uppercase tracking-tight text-base sm:text-lg text-white">Buat Sesi Baru</h3>
